...
import (
	...
	tokenRepo "server/internal/domain/auth/user/repository"
...
func (s *UserAuthService) VerifyUser(email string, password string) (*model.User, error) {
...
func (s *UserAuthService) VerifyAccessToken(encryptedToken string) (*model.User, *auth.UserToken, error) {
