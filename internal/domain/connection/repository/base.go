...
import (
	...
	"errors"
	"fmt"
	applicationModel "server/internal/domain/application/model"
	"server/internal/domain/connection/model"
	"time"
...
func (r *ConnectionRepository) GetWithApplication(id uuid.UUID) (*model.Connection, error) {
	query := `
